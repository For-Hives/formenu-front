...
export function PrimaryFeatures() {
    ...
    >
        <div className="mx-auto lg:max-w-[100rem] min-[1950px]:max-w-[120rem] px-4 sm:px-6 lg:px-8 relative">
            ...
            >
                {({selectedIndex}) => (<>
                    <div
                        ...
                        <Tab.List id={"tablist"}
                            ...
                            {features.map((feature, featureIndex) => (<div
                                key={feature.title}
                                className={clsx('group relative rounded-xl py-1 px-4 lg:p-6', selectedIndex === featureIndex ? 'bg-white lg:bg-white/10 lg:ring-1 lg:ring-inset lg:ring-white/10' : 'hover:bg-white/10 lg:hover:bg-white/5')}
                            >
                                <h3>
                                    <Tab
                                ...
                                <p
                                    className={clsx('mt-2 hidden text-sm lg:block', selectedIndex === featureIndex ? 'text-white' : 'text-formenu-indigo-100 group-hover:text-white')}
                                >
                                    {feature.description}
                                </p>
                            </div>))}
                    ...
                    <Tab.Panels className="lg:col-span-7 min-[1950px]:col-span-7">
                        {features.map((feature) => (<Tab.Panel key={feature.title} unmount={false}>
